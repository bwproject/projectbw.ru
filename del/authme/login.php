...
<head>
  ...
  <title>PROJECTBW.RU | Login</title>
...
<body min-height="3500" class="my-login-page"><br /><br />
  <div class="container">
		...
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					<div class="card fat">
						<div class="card-body">
							<h4 style="color:#e38809" class="card-title">PROJECTBW.RU <small class="text-muted"> ВОЙТИ</small></h4>
        ...
        if ($was_successful === true) {
            ...
            $_SESSION["username"] = $user;
                ...
                ?>
								...
								<div class="form-group no-margin">
									<button class="btn btn-warning btn-block" href="index.html" >Главное меню</button>
								</div>	
