!function(){
    ...
    n=function(){
        function n(t){
            var r=t.ip,i=t.element,o=t.format,a=t.refreshRate;
            ...
            key:"runQuery",value:function(){
                ...
                t.onreadystatechange=function(){
                    if(4===t.readyState&&200===t.status){
                        ...
                        n.online&&(e.element.innerHTML=e.format.replace(/{\b(online|max)\b}/gi,function(e,t){return n.players["online"===t?"now":t]}))
                    }
                },
    ...
    r=function(){
        for(var e=document.querySelectorAll("[server-ip]"),
        t=0;t<e.length;t++){
            var r=e[t];new n({
                element:r,ip:r.getAttribute("server-ip"),
